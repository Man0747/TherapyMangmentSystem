$(document).ready(function () {
    ...
    $("#start-date").change(morninggenerateSlots);

    $("#selects-slot").change(function () {
...
function getDateFromInput() {
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.scheduleExists == true) {
                // Schedule exists
                ...
                // Debugging: Log response and slots
                console.log('Response:', response);
                console.log('Slots:', response.Slots);

                // Assign response.Slots to slots array
